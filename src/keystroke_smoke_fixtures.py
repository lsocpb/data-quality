...
EXPECTED_SMOKE_K = 1
EXPECTED_IDENTIFICATION_THRESHOLD = 0.093969
EXPECTED_IDENTIFICATION_REJECT_THRESHOLD = 0.01
EXPECTED_VERIFICATION_ACCEPT_CLAIM = "Majkel"
EXPECTED_VERIFICATION_REJECT_CLAIM = "Anita"
